...
class AnnealingLR(_LRScheduler):
    ...
    def __init__(self, optimizer, start_lr, warmup_iter, num_iters, decay_style=None, last_iter=-1,generate_mode=-1,mid_iter=-1):
        ...
        self.mid_iter = num_iters//2 if mid_iter<0 else mid_iter
    ...
    def load_state_dict(self, sd):
        ...
        self.mid_iter = sd['mid_iter']
        self.generate_mode = sd['generate_mode']
