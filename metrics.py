...
class Rouge(Rouge155):
    ...
    def __init__(self, n_words=None,
        ...
        super(Rouge, self).__init__(
            ...
            keep_files=keep_files,rouge_home='/Storage/wanghan/dependency/pyrouge/tools/ROUGE-1.5.5')
        self._rouge_data = '/Storage/wanghan/dependency/pyrouge/tools/ROUGE-1.5.5/data'#'/home/u3043377/pyrouge/tools/ROUGE-1.5.5/data'
        #print('self._rouge_bin=',self._rouge_bin)
    def _run_rouge(self):
        # Get full options
        options = (
            ['-e', self._rouge_data] +
